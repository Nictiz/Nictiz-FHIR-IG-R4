...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/" name="buildIGResource">
        ...
        <ImplementationGuide xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://hl7.org/fhir https://build.fhir.org/fhir-all.xsd" xmlns="http://hl7.org/fhir">
            <id value="nictiz.fhir.nl.r4.bgz"/>
            ...
            <url value="http://nictiz.nl/fhir/ImplementationGuide/nictiz.fhir.nl.r4.bgz"/>
            ...
            <version value="dev"/>
            <name value="Nictiz-R4-BgZ"/>
            <title value="Nictiz R4 BgZ"/>
            <status value="draft"/>
            ...
            <packageId value="nictiz.fhir.nl.r4.bgz"/>
            ...
            <dependsOn>
                <uri value="http://nictiz.nl/fhir/ImplementationGuide/nictiz.fhir.nl.r4.eafspraak"/>
                <packageId value="nictiz.fhir.nl.r4.eafspraak"/>
                <version value="dev"/>
            </dependsOn>
            <definition>
